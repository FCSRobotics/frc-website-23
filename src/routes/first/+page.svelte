<div id="content">
  <div id="text">
    <h2>What is FIRST?</h2>
    <p>
      FIRST is a global robotics organization that aims to prepare students to
      become future leaders in science and technology. The acronym FIRST stands
      for “For the Inspiration and Recognition of Science and Technology”.
      Through various competitions including FIRST Lego League, FIRST Tech
      Challenge, and FIRST Robotics Competition, students of all grades K-12
      have an opportunity to work with skilled adult mentors in a fast-paced,
      collaborative environment in order to solve real world technological
      challenges through building robots. FIRST’s mission is to inspire
      innovation and foster well-rounded, self-confident student-leaders. <a
